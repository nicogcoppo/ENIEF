...
plot "./GRAFICAS_FINALES//data_fuerzas.dat" using 1:($2+$5) ti "Fx" w l,"" using 1:($3+$6) ti "Fy" w l,"" using 1:(a * sin($1)) ti "Fx Teorica" w l,"" using 1:(-a * cos($1)) ti "Fy Teorica" w l 
...
plot "./GRAFICAS_FINALES/data_fuerzas.dat" using 1:(sqrt(($2+$5)**2+($3+$6)**2+($4+$7)**2)) ti "Resultante" w l,
...
plot "./GRAFICAS_FINALES//data_momentos.dat" using 1:($4+$7) ti "Mz" w l
